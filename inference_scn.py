...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='[Indonesian Image Captioning] -- (S)emantic (C)ompositional (N)etworks -- Generate Caption')

    parser.add_argument('--img', '-i', help='path to image')
    parser.add_argument(
        '--model', '-m', default='./pretrained/BEST_checkpoint_scn_flickr10k_5_cap_per_img_5_min_word_freq.pth.tar', help='path to model')
    parser.add_argument(
    ...
    seq, tags = caption_image_beam_search(
