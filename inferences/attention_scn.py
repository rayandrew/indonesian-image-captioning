...
def caption_image_beam_search(encoder_img, encoder_tagger, decoder_tagger, decoder_scn, image_path, tag_map, word_map, beam_size=3):
    ...
    while True:
        ...
        awe, alpha = decoder_scn.attention(encoder_out, h)
...
def visualize_att(image_path, seq, alphas, rev_tag_map, rev_word_map, smooth=True):
    """
...
if __name__ == '__main__':
    ...
    visualize_att(args.img, seq, alphas, rev_tag_map,
                  rev_word_map, args.smooth)
